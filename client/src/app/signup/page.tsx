    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2">Get started</h1>
          <p className="text-gray-600 dark:text-gray-400">Create your DevStudio account in seconds</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="mt-6 text-center text-sm">
            <p className="text-gray-600 dark:text-gray-400">
              ...
              <Link href="/login" className="text-[#166EC1] hover:text-[#145ca5] font-semibold transition-colors">
                Sign in
              </Link>
            </p>
          </div>
